...
| Legacy CTGAN/TVAE snapshot | `TabDDPM-main/CTGAN/CTGAN/` | Historical `sdv-dev/CTGAN` source, version `0.5.2.dev0` | MIT, `TabDDPM-main/CTGAN/CTGAN/LICENSE` | No longer used by the CTGAN adapter. Temporarily retained only because the unvalidated TVAE path still imports it; exact revision and final disposition will be handled during TVAE validation. |
