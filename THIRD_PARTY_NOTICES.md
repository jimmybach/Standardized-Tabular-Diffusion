...
| TabSyn and bundled baselines | `TabSyn-main/` | `amazon-science/tabsyn` at `cb5ac0f74ec36ee88e7a974a393dfbef50d42da7` | Apache-2.0, `TabSyn-main/LICENSE`, with `TabSyn-main/NOTICE` | Five shared TabSyn files were compatibility-patched at import, with further dependency shims added later. Native parity and the licenses of nested baseline snapshots remain to be reviewed. |
