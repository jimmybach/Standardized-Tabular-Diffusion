...
| TabSyn and bundled baselines | `TabSyn-main/` | `amazon-science/tabsyn` at `cb5ac0f74ec36ee88e7a974a393dfbef50d42da7` | Apache-2.0, `TabSyn-main/LICENSE`, with `TabSyn-main/NOTICE` | The 20-file primary TabSyn execution scope is restored to and checksum-frozen against the official tree. Compatibility behavior is outside upstream source. Native parity is pending; bundled baseline snapshots still require independent license/source review. |
