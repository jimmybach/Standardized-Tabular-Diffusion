...
P4 adds checksum-bound real-train, held-out real-test, and synthetic-train inputs; three-family Local Utility with raw Dummy/TRTR/TSTR arms and unclipped baseline-adjusted retention; and TabStruct Equation 4 Global Utility with every target, raw arm, predictor set, seed, denominator, and failure state retained. Its bounded diagnostic workflow passed on [Linux/Python 3.11](https://github.com/jimmybach/Standardized-Tabular-Diffusion/actions/runs/31053624769), and a separate [real source-runtime pilot](https://github.com/jimmybach/Standardized-Tabular-Diffusion/actions/runs/31057073762) passed exact adapter parity with XGB/KNN/TabPFN. The first preregistered [Adult/Sick dataset-scale admission run](https://github.com/jimmybach/Standardized-Tabular-Diffusion/actions/runs/31060416318) failed: Adult execution was incomplete after runner shutdown, while complete Sick execution passed its resource envelope but failed two stability sentinels. P4 therefore remains diagnostic and excluded from Official Results; see the [P4 guide](docs/evaluation/P4_UTILITY.md) and retained [admission decision](docs/evidence/evaluation/p4-dataset-scale-admission-decision-run-31060416318.json).
