...
| `RF-GOGGLE-001` | Goggle passes the sample seed to its compatibility launcher; the launcher applies it to Python, NumPy, PyTorch, and `PYTHONHASHSEED`. | Adapter command assertion with a seed distinct from training. |
