...
| `goggle` | Method-author GCN core plus dependency compatibility backend | [vanderschaarlab/GOGGLE](https://github.com/vanderschaarlab/GOGGLE) at `1a3d87ad` | Eighteen official files remain checksum-locked and unpatched. Historical run `30945676747` retains exact DGL native parity for the GCN core. Windows uses the separately declared pure-PyTorch graph backend; formal DGL 1.1.3 backend-parity evidence, SAGE/heterogeneous support, Official Results, and release gates remain pending. |
