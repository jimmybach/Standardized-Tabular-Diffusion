...
- Release environment: Windows 11/Python 3.11 primary qualification pending; retained parity evidence is Linux/Python 3.11
...
The selected source is the official [SDMetrics repository](https://github.com/sdv-dev/SDMetrics/tree/ba8842f2ba04ce914f698cc1cf746ca12338ab0e) at commit `ba8842f2ba04ce914f698cc1cf746ca12338ab0e`, distribution version `0.28.3.dev0`, under MIT. The backend hashes the LF-normalized bytes of all 121 installed Python source files and requires tree digest `784beda5c7a63d5ebb5fe74f98d00db3a2e018a29b2f32f643bf857750a6c2a9`. It also requires the LF-normalized installed MIT license digest `1310119ad2a00b68f05d86309aea0bf1d3853e747d4f5646b1bf60a5a07f09a8`. Line-ending normalization makes source and license attestation independent of checkout or wheel-building policy without ignoring executable or legal text differences. A version, source-tree, or license mismatch stops evaluation before any metric is reported.
