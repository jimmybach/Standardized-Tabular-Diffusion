...
| [`schemas/evaluation/`](../../standardized_tabular_diffusion/schemas/evaluation) | Fourteen Draft 2020-12 wire schemas | P1 scientific contracts plus P6 hardware/software/run/stage orchestration contracts, packaged in the wheel |
...
### 3.3 Remaining gaps after P6 implementation
...
The complete Adult/Sick identity-surrogate path passed under Windows 11 and Python 3.11 at commit `c66fa23`; its [machine-readable evidence](../evidence/evaluation/p5-windows-py311-identity-c66fa23.json) is retained. The first exploratory real-generator pilot subsequently trained the pinned TabDDPM Adult `ddpm_cb_best` configuration for 30,000 steps, generated three complete tables at seeds `0,1,2`, and finalized all three P5 bundles. Adult/Sick privacy roles and the bounded released-table black-box membership threat model were then reviewed. The independent seeds `3,4,5` design was fixed in the [confirmatory preregistration](../evidence/evaluation/p5-confirmatory-preregistration-2026-08-13.json) and passed all completeness, structural, provenance, and environment gates. The [freeze decision](../evidence/evaluation/p5-protocol-freeze-decision-2026-08-13.json) did not use favorable metric values and admits only the ten metric components conditionally.
...
- [P6 Resource-Aware Orchestration Guide](P6_ORCHESTRATION.md)
