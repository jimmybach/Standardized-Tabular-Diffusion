...
| [`evaluation/utility.py`](../../standardized_tabular_diffusion/evaluation/utility.py) | Held-out-test Local/Global Utility, raw arms, support states, and strict ratio aggregation | P4 unit-validated diagnostic path; executable TabEval runtime parity remains pending |
...
- P4 Local/Global Utility is unit-validated as a diagnostic vertical slice. Its exact optional TabEval predictor runtime, resource budget, stability pilot, and source-parity evidence remain pending before protocol freeze.
...
| P4 | Local and Global Utility | P1, P3 | Unit-validated diagnostic implementation; source-runtime pilot pending | Raw arms, state semantics, profile identity, and source/formula validation pass |
