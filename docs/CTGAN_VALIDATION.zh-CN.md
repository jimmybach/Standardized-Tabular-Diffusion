...
仓库过去在 `TabDDPM-main/CTGAN/` 下包含一个经过本地修改的 CTGAN `0.5.2.dev0` 副本。TVAE 也迁移到官方包之后，该 47 文件旧子树及失效包装脚本已从当前工作树删除。其历史仍可通过 Git 恢复，source lock 则记录其版本、最接近的已审阅上游关系、修改状态、大小和哈希。
