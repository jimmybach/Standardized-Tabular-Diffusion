...
- `ctab-gan-adult-smoke.json` exercises the distributed checksum-locked official classification source with reduced CPU dimensions. Formal validation is governed by `docs/CTABGAN_VALIDATION.md`; a smoke preset alone never promotes validation status.
