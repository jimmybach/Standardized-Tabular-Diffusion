...
_ADAPTER_SPECS: dict[str, AdapterSpec] = {
    ...
    "great": _spec(
        ...
        license_status="MIT package dependency; native parity and release gates pending",
        evidence_records=(
            "docs/UPSTREAM_SOURCE_AUDIT.md",
    ...
    "tabsds": _spec(
        ...
        revision_status="pinned-method-author-source-parity-pending",
        license_status="No upstream license declared; redistribution and release blocked",
        evidence_records=(
            "docs/UPSTREAM_SOURCE_AUDIT.md",
    ...
    "tabebm": _spec(
        ...
        revision_status="pinned-official-package-smoke-pending",
        license_status="Apache-2.0 package dependency; full gated TabPFN generation not yet validated",
        evidence_records=(
            "docs/UPSTREAM_SOURCE_AUDIT.md",
